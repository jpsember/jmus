...
public final class MusUtil {
  ...
  public static DFA dfa() {
    if (mDFA == null)
      mDFA = new DFA(JSMap.fromResource(MusUtil.class, "tokens.dfa"));
    return mDFA;
  }
  ...
  public static final int T_CHORD = 3;
  public static final int T_FWD_SLASH = 4;
  public static final int T_PAROP = 5;
  public static final int T_PARCL = 6;
  public static final int T_PERIOD = 7;
  public static final int T_TITLE = 8;
  public static final int T_SUBTITLE = 9;
  public static final int T_TEXT = 10;
  public static final int T_SMALLTEXT = 11;
  public static final int T_BEATS = 12;
  public static final int T_KEY = 13;
  public static final int T_BWD_SLASH = 14;
